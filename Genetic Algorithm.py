...
data_pd = pd.read_csv("C:/Users/HP/Documents/Jupyther/Praktek/Parkinsson disease.csv")
...
chromo_df_pd,score_pd=generations(data_pd,label_pd,size=80,n_feat=data_pd.shape[1],n_parents=64,mutation_rate=0.20,n_gen=10,
...
plot(score_pd,0.9,1.050,c = "orange")
